...
dirR <- "C:\\Users\\abiya\\Downloads\\Geog331\\Activity 7 data-20200427\\oneida"
...
viewRGB(rgbS,r=1,g=2,b=3,maxpixels =  2297430,quantiles = c(0.00,0.995), homebutton=FALSE,
  ...
  mapview(agri, color="grey25",col.regions="violet")+mapview(built, color="grey25",
                                                             col.regions="darkgoldenrod3")+
  mapview(forest, color="grey25",col.regions="tan4")+mapview(water, color="grey25",col.regions="royalblue")+
...
allbandsCloudf <- stack(allbandsCloud[[1]],allbandsCloud[[2]],allbandsCloud[[3]],allbandsCloud[[4]],
                        allbandsCloud[[5]],allbandsCloud[[6]],allbandsCloud[[7]],allbandsCloud[[8]],allbandsCloud[[9]])
...
algal.count.rf<- freq(rf_prediction)[1,2] #cell count 
area.algal.rf<- algal.count.rf*cell.area
#area.algal.rf is 97,481,600  sq. m

algal.count_nnet<- freq(nnet_prediction)[1,2] #cell count 
area.algal_nnet<-algal.count_nnet*cell.area
#area.algal.nnet is 120,545,200 sq. m

difference<- area.algal.rf-area.algal.nnet
#There is a difference of 10,064,000 sq. m between the area predicted by NNM  and RFM
